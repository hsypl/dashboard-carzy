package com.crazy.code.httpclient;
...
public class HttpClientUtils {
     ...
     * @throws HttpClientException
     */
    public static CloseableHttpResponse getResponse(String url, Header header)
            throws HttpClientException {
        try {
    ...
    public static String postJson(String url, String jsonData, Header header)
            throws HttpClientException {
        return parseContent(post(url, createJsonEntity(jsonData), header));
    }
    ...
    public static String postApiJson(String url, String jsonData, Header header)
            throws HttpClientException {
        return parseContent(post(url, createApiJsonEntity(jsonData), header));
    }
    ...
    public static String postForm(String url,String params, Header header)
            throws HttpClientException {
        return parseContent(post(url, createPostEntity(params), header));
    }
     ...
     * @throws HttpClientException 如果请求失败，将抛出该异常
     */
    public static HttpEntity post(String url, StringEntity postEntity, Header header)
            throws HttpClientException {
        try {
